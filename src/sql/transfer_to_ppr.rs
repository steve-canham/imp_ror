...
pub fn get_admin_data_sql <'a>() -> &'a str {
...
pub fn get_external_ids_sql <'a>() -> &'a str {
...
pub fn get_locations_sql <'a>() -> &'a str  {
...
pub fn get_domains_sql <'a>() -> &'a str {
