 ...
 * Once established the log file is accessible to any log
 * statement within the rest of the program (if a 'use log:: ...' 
 * (info, error etc.) statement is within the module use statements.
 ***************************************************************************/
